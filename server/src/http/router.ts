...
export const applyRouter = (authUsecase: AuthUseCase, notificationUsecase: NotificationUsecase, profileUsecase: ProfileUsecase, app: Express): Express => {
    ...
    app.post("/api/profile/create", httpProfileController.createProfile.bind(httpProfileController))
    app.post("/api/profile/edit", httpProfileController.setProfile.bind(httpProfileController))
